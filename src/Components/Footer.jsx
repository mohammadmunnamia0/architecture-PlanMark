...
function Footer() {
  return (
    <div>
      <FooterTop></FooterTop>
      <footer className="font-sans tracking-wide bg-black px-10 pt-16 pb-6">
        <div className="flex flex-wrap justify-between gap-10">
          <div className="max-w-md">
            ...
            <div className="mt-6">
              <p className="text-white leading-relaxed text-sm">
                ...
                injected humour, or randomised words 0 Latin
              </p>
            </div>
          ...
          <div className="max-lg:min-w-[140px]">
            <h4 className="text-white font-semibold text-base relative max-sm:cursor-pointer">
              Categries
            </h4>
          ...
          <div className="max-lg:min-w-[140px]">
            ...
            <ul className="space-y-4 mt-6 text-white">
              <li>
               <p>6/5,South Rajarbag,Bashabo, Sabujbag, <br /> Dhaka1214 Bangladesh</p>
              </li>
              <li>
                +8801324738600
              </li>
